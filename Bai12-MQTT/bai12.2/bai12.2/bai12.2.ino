...
// ========== CẤU HÌNH MQTT ==========
const char* mqtt_server = "192.168.1.123";  // Thay bằng IP của HA
const int mqtt_port = 1883;

// Thông tin đăng nhập MQTT (phải trùng với cấu hình trong Mosquitto)
const char* mqtt_user = "phuanh1";        // Username MQTT
const char* mqtt_pass = "1234";        // Password MQTT

// Mã sinh viên
const char* student_id = "12423001";            // Thay bằng mã sinh viên thật
